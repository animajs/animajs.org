define("anima-underscore/1.0.0/index-debug", ["anima-underscore/1.0.0/src/underscore-debug"], function (require, exports, module) {
  module.exports = require("anima-underscore/1.0.0/src/underscore-debug");
});
define("anima-underscore/1.0.0/src/underscore-debug", [], function (require, exports, module) {
  //     Underscore.js 1.6.0
  ...
  var eq = function (a, b, aStack, bStack) {
    ...
    var aCtor = a.constructor,
        bCtor = b.constructor;
    if (
    aCtor !== bCtor && 'constructor' in a && 'constructor' in b && !(_.isFunction(aCtor) && aCtor instanceof aCtor && _.isFunction(bCtor) && bCtor instanceof bCtor)) {
      return false;
    }
